<?php
	...
	$courseCode = $section = $numberofStudent = $teacherInitial = "";
	$roomNo = "";
				...
				if($checkRoom>0){
					for($k=0;$k<10;$k++){
						if($colArray[$k] >0 && $numberofStudent>0){
							...
							$k++;
							$colno = "Col".$k;
							$sqlIsertReport = "INSERT INTO Report(courseCode, section, teacherInitial, roomNo, colNo, numberofStudent)
								values('$courseCode', '$section', '$teacherInitial', '$roomNo', '$colno', '$assignedStudentNo')";
	...
	require 'reporttitle.php';
	//echo "<div align='center'><a href='title.php'><button align='center'>Show Report</button></div>";
?>
<!--
<html>
...
<body>
	...
	<form method="post" action="title.php">
		...
		<div class="relative"><input class="relative3" type="submit" name="add" value="Show Report"></div>
	</form>
	</div>
	</div>
</body>
