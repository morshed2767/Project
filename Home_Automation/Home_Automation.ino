...
const char* ssid = "special virous"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "abedofrose@#"; // Your Wifi password, in case you have open network comment the whole statement.
